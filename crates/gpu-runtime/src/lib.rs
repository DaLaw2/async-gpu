...
pub mod prelude {
    ...
    pub use gpu_protocol::{
        ...
        PKT_OFF_PAYLOAD, PKT_OFF_SERVICE, PRINT_MAX_MSG_LEN, SERVICE_ASSERT, SERVICE_BULK_READ,
        SERVICE_BULK_WRITE, SERVICE_CLOSE, SERVICE_OPEN, SERVICE_PANIC, SERVICE_PRINT,
        SERVICE_READ, SERVICE_STDIN, SERVICE_TIME, SERVICE_TRACE, SERVICE_WRITE, TRACE_LEVEL_DEBUG,
