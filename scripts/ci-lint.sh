...
# --- host check ---
run "check async-gpu" "cargo +stable check --manifest-path crates/async-gpu/Cargo.toml"
...
# Note: crates/test/std-build-test, crates/kernel/gpu-kernel-std, crates/kernel/gpu-kernel-core excluded — require patched std to build
